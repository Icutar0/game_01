...
class Game:
    def __init__(self):
        ...
        self.load_top_players()  # Перенесем вызов метода сюда
    ...
    def run(self):
        while True:
            ...
            if not self.is_game_over:
                ...
                while True:  # Добавлен дополнительный цикл
                    for event in pygame.event.get():
                        if event.type == pygame.QUIT:
                            pygame.quit()
                            return
                    self.display_top_players()  # Вывести список топ-5 игроков на экране
